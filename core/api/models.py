...
class EventVoucher(models.Model):
	...
	def is_redeemed(self) -> bool:
		...
		if self.voucher.voucher_type == "SILVER" and self.is_redeemed >= 1:
			return True
		elif self.voucher.voucher_type == "GOLD" and self.is_redeemed >= 2:
			return True
		elif self.voucher.voucher_type == "DIAMOND" and self.is_redeemed >= 3:
			return True
		else:
			return False
